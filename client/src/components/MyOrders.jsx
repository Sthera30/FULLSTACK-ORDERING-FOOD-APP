...
function MyOrders() {
  ...
  async function handle_click(id) {
    ...
    try {
      ...
      const res = await axios.get(`https://fullstack-ordering-food-app-backend.vercel.app/getAddressByOrder`, { params: { id } })
  ...
  async function handle_filte_status() {
    ...
    try {
      ...
      const res = await axios.get(`https://fullstack-ordering-food-app-backend.vercel.app/filterStatus?status=${status}`)
  ...
  async function handle_price_filter() {
    ...
    try {
      ...
      const res = await axios.get(`https://fullstack-ordering-food-app-backend.vercel.app/filterPrice?priceRange=${price}`)
  ...
  async function handle_filter() {
    ...
    try {
      ...
      const res = await axios.get(`https://fullstack-ordering-food-app-backend.vercel.app/filterDate?startDate=${startDate}&endDate=${endDate}`)
