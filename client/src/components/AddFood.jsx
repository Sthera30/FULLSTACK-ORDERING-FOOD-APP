...
function AddFood() {
    ...
    async function handle_onchange(e) {
        ...
        try {
            ...
            const response = await axios.post('https://fullstack-ordering-food-backend-app.onrender.comupload', formData)
    ...
    async function handle_submit(e) {
        ...
        try {
            ...
            const { data } = await axios.post("https://fullstack-ordering-food-backend-app.onrender.comadd", { name, description, price, category, weight, foodImage, specificationName },
                {
                    headers: {
