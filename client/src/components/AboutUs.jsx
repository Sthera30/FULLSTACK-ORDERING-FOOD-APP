...
function AboutUs() {
    ...
    async function handle_fetch_about() {
        ...
        try {
            ...
            const res = await axios.get("https://fullstack-ordering-food-app-backend.vercel.app/getAboutUs")
    ...
    async function handle_fetch_mission() {
        ...
        try {
            ...
            const res = await axios.get("https://fullstack-ordering-food-app-backend.vercel.app/getMission")
    ...
    async function handle_fetch_vision() {
        ...
        try {
            ...
            const res = await axios.get("https://fullstack-ordering-food-app-backend.vercel.app/getVision")
    ...
    async function handle_fetch_core_values() {
        ...
        try {
            ...
            const res = await axios.get("https://fullstack-ordering-food-app-backend.vercel.app/getValues")
    ...
    async function handle_remove_about_us(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-ordering-food-app-backend.vercel.app/remove_about_us?id=${id}`)
    ...
    async function handle_remove_mission(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-ordering-food-app-backend.vercel.app/remove_mission?id=${id}`)
    ...
    async function handle_remove_vision(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-ordering-food-app-backend.vercel.app/remove_vision?id=${id}`)
    ...
    async function handle_remove_values(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-ordering-food-app-backend.vercel.app/remove_values?id=${id}`)
