...
function OurPromise() {
    ...
    async function fetch_promise() {
        ...
        try {
            ...
            const res = await axios.get(`http://https://fullstack-ordering-food-backend-app.onrender.com/getPromise`)
    ...
    async function remove_promise(id) {
        ...
        try {
            ...
            const { data } = await axios.delete(`http://https://fullstack-ordering-food-backend-app.onrender.com/removePromise?id=${id}`)
