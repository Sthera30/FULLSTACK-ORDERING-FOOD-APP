...
function OurPromise() {
    ...
    async function fetch_promise() {
        ...
        try {
            ...
            const res = await axios.get(`https://fullstack-ordering-food-backend-app.onrender.comgetPromise`)
    ...
    async function remove_promise(id) {
        ...
        try {
            ...
            const { data } = await axios.delete(`https://fullstack-ordering-food-backend-app.onrender.comremovePromise?id=${id}`)
