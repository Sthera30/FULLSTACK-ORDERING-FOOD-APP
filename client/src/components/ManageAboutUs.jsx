...
function ManageAboutUs() {
    ...
    async function handle_add_about_us() {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:8090/add_about_us`, { aboutUsHeading, aboutUsDescription, aboutUsImage })
    ...
    async function handle_add_mision() {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:8090/add_mission`, { missionHeading, missionDescription })
    ...
    async function handle_add_vision() {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:8090/add_vision`, { visionHeading, visionDescription })
    ...
    async function handle_add_values() {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:8090/add_values`, { valuesHeading, valuesDescription })
