...
function ExploreMore() {
    ...
    async function handle_food_fetch() {
        ...
        try {
            ...
            const res = await axios.get("https://fullstack-ordering-food-app-backend.vercel.app/allFood")
    ...
    async function handle_search(e) {
        ...
        try {
            ...
            const res = await axios.get(`https://fullstack-ordering-food-app-backend.vercel.app/foodSearch?term=${searchTerm}`)
    ...
    async function handle_remove(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-ordering-food-app-backend.vercel.app/delete_food?id=${id}`)
